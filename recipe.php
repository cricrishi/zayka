...
<ul id="rcontainer">
<li><a href="?" class="current" id="all" >ALL Recipes</a></li>
<li><a href="?recipe=top" id="top" >Top Recipes</a></li>
<li><a href="?recipe=new" id="new" >New Recipes</a></li>
<li><a href="?recipe=our" id="our" >Our Recipes</a></li>
</ul>
<div id="recipies">
...
$result=getrecipes($recipe);
$count=ceil(mysql_num_rows($result)/10);
$l="recipe.php?";
if(isset($_REQUEST['recipe']))
$l=$l."recipe=".$_REQUEST['recipe'];
for($i=1;$i<=$count;$i++)
{
if($page==$i)
{
...
echo "<a class=\"page\" href=\"$l&page=$i\">$i</a>";
...
document.getElementById("our").className = "";

document.getElementById(r).className = "current";
